...
describe('FarewellPodiumView', () => {
  ...
  it('singularizes a one-bingo champion stat line', () => {
    render(
      <FarewellPodiumView
        podium={{ champion: { uid: 'x', displayName: 'Solo', bingoCount: 1, squaresMarked: 5 }, firstBingo: null, dailyHonors: [], runnersUp: [], playRecorded: true }}
      />,
    );
  ...
  it('renders nothing for an entirely empty podium', () => {
    const { container } = render(
      <FarewellPodiumView podium={{ champion: null, firstBingo: null, dailyHonors: [], runnersUp: [], playRecorded: false }} />,
    );
...
describe('FarewellPodiumView — Most-Loved Photo section (#561)', () => {
  ...
  it('an award section keeps an otherwise-empty podium alive (no null short-circuit)', () => {
    const { container } = render(
      <FarewellPodiumView
        podium={{ champion: null, firstBingo: null, dailyHonors: [], runnersUp: [], playRecorded: false }}
