...
- A Player block ([ADR 0016](0016-player-blocking.md)) never removes the verification channel: Doubt creation stays open across a block by default, because a block that gated it would let a Player block their way out of being doubted.
