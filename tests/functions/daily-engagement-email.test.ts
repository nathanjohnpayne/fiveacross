...
describe('sendDailyEmailForEvent', () => {
  ...
  // specs/post-sailing-archive.md (#134, Codex P2 on PR #1139). A frozen Event
  // is a stopped one, and this sweep is the last thing in the estate that would
  // still be inviting people to play on it: every gameplay write the mail asks
  // for is denied at the rules boundary from the moment the Event shuts.
