...
- Live verification (manual, post-deploy): with the service worker active, the top-level sign-in navigation to `/__/auth/handler` renders Google's account chooser, not the SPA.
