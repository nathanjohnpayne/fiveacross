...
The settings/Claim-Mode/roster claims below hold for EVERY registered Event payload; the pool-density section's 80-entry pin is the med-2026 Event's own (each Event pins its own counts—Bodega Bay pins 40/40/40 in `seed-pools-per-event.test.ts`).
