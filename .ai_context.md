...
This repository is **fiveacross** (`nathanjohnpayne/fiveacross`, renamed from `gaycruisebingo` on 2026-08-27), a live multiplayer bingo PWA. It serves several Editions — Gay Cruise Bingo, Vacay Bingo and Five Across — so the repository is not identical to any one of them. It follows the AI Agent Tooling Standard defined in `ai_agent_tooling_standard.md` as a downstream **consumer** of the **mergepath** template — mergepath, not this repo, is the canonical template for projects in this GitHub account.
